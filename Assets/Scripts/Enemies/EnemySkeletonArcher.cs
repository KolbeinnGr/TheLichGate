...
public class EnemySkeletonArcher : MonoBehaviour
{
    ...
    [SerializeField] GameObject arrowPrefab; // Assign your arrow prefab in the inspector
    [SerializeField] Transform shootingPoint; // Assign a point on your archer where the arrow will be shot from
    [SerializeField] float arrowSpeed; // Adjust this value as needed
    ...
    public void ShootArrow() {
        if(targetDestination != null) {
            ...
            rb.velocity = direction * arrowSpeed; // Adjust arrowSpeed as needed
